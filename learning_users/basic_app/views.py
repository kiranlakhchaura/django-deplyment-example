...
# new imports for login/logout facilities
...
def register(request):
    ...
    return render(request,'basic_app/registration.html',context={'registered':registered, 'user_form':user_form, 'profile_form':profile_form})
